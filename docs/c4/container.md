...
C4Container
    ...
    System_Boundary(sm, "signalman") {
        Container(serve, "Webhook receiver", "Rust, axum, tokio", "POST /webhooks/incidentio: verifies, deduplicates, acknowledges, runs the triage in the background. GET /healthz for liveness, GET /readyz for readiness against the upstreams.")
